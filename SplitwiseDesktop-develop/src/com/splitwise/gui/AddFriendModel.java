...
public class AddFriendModel extends CJPanel {
	...
	public void initComponents() {
		...
		headerText = new JLabel("Add or Invite a Friend");
	...
	public void computePlacement() {
		...
		cancelButton.setLocation(inviteButton.getX() - paddingLeft - cancelButton.getWidth(), (buttonPanel.getSize().height - cancelButton.getSize().height)/2);
	...
	public void saveAction() {
		String email = description.getText();
